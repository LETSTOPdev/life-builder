...
export default function AboutPage() {
  return (
    <StaticShell>
      ...
      <div className="space-y-8 text-[#888] text-base leading-relaxed">
        <div>
        ...
        <div>
          <h2 className="text-white font-semibold text-lg mb-3">Built Different</h2>
          <p>
            We built Buildr around one core insight: the goal of any productivity system is not to collect data — it&apos;s to create belief. When you leave Buildr, you should think: <em className="text-white">&ldquo;For the first time, I know exactly what I should do next.&rdquo;</em>
          </p>
        </div>

        <div className="border-t border-white/8 pt-8">
          <p className="text-[#555] text-sm">Founded in 2024 · San Francisco, CA · Remote-first</p>
        </div>
      </div>
    </StaticShell>
  );
